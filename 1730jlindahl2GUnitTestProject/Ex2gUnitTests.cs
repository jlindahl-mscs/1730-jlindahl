...
using _1730jlindahl2G;

namespace _1730jlindahl2GUnitTestProject
{
    [TestClass]
    public class Ex2gUnitTests
    {
        ...
        {
            Assert.AreEqual("-0.1", Ex2GCalculations.If01("Z"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("-0.1", Ex2GCalculations.ElseIf01("Z"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("-0.1", Ex2GCalculations.NestedIfElse01("Z"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("-0.1", Ex2GCalculations.If02("Z"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("-0.1", Ex2GCalculations.ElseIf02("Z"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("-0.1", Ex2GCalculations.NestedIfElse02("Z"));
        }
