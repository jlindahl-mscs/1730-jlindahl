<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_1730jlindahl2H1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <asp:TextBox ID="TextBox3aResult" runat="server" Enabled="False" Width="36px"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6a" runat="server" Width="35" Text="2019"></asp:TextBox>
                <asp:TextBox ID="TextBox6b" runat="server" Width="30" Text="11"></asp:TextBox>
                <asp:TextBox ID="TextBox6c" runat="server" Width="30" Text="01"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox7" runat="server" Text="November 1, 2019"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9a" runat="server" Width="75">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox9b" runat="server" Width="75">12/12/2012</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox10a" runat="server" Width="75">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox10b" runat="server" Width="75px">12/12/2012</asp:TextBox>
